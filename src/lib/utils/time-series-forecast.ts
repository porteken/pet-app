/**
 * Time Series Forecasting using Holt's Linear Trend Method
 * This is a double exponential smoothing technique that's well-suited
 * for time series data with trends, like climate data.
...
export class TimeSeriesForecast {
  ...
  /**
   * Forecast h steps ahead with realistic year-to-year variability
   */
  ...
  /**
   * Get the current level and trend
   */
  ...
  /**
   * Seeded pseudo-random number generator for consistent variability
